...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstanceClone) DeepCopyInto(out *InstanceClone) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstanceClone.
func (in *InstanceClone) DeepCopy() *InstanceClone {
	if in == nil {
		return nil
	}
	out := new(InstanceClone)
	in.DeepCopyInto(out)
	return out
}
